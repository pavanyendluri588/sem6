...
legend("topright",data2$Education ,cex = 0.6,fill=rainbow(length(data2$Attrition_count)))
...
legend("topleft",data4$Gender,cex=1.6,fill=rainbow(length(data4$Attrition_count)))
...
legend("topright",data6$Job_Role,cex=1 ,fill=rainbow(length(data6$Monthly_Income)))
...
legend("topright",data8$Education ,cex=1,fill=rainbow(length(data8$Monthly_Income)))
