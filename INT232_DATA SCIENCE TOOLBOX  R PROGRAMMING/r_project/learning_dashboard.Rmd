...
legend("topright",data2$Education, cex=0.5,fill=rainbow(length(data2$Attrition_count)))
...
Monthly income based on the job roles
================================
...
par(bg = "Tomato")
barplot(data6$Monthly_Income,main="Monthly income based on the job roles ", names.arg = data6$Job_Role,col=rainbow(length(data6$Monthly_Income)))
legend("topright",data6$Job_Role,cex=0.6 ,fill=rainbow(length(data6$Monthly_Income)))
...
legend("topright",data7$Department ,cex=1,fill=rainbow(length(data7$Employee_Count)))
...
legend("topright",data8$Education ,cex=0.6,fill=rainbow(length(data8$Monthly_Income)))



```

Department wise salary hiKe
==============================
...
par(bg = "Steelblue")
pie(data9$Percent_Salary_Hike,main="Department Wise Salary HiKe",explode=0.07,labels =data9$Percent_Salary_Hike ,col=rainbow(length(data9$Percent_Salary_Hike)))
legend("topright",data9$Department ,cex=1,fill =rainbow(length(data9$Percent_Salary_Hike)))
```